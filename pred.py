...
cursor = db.cursor()
current_epoch = 1676248441

while current_epoch < int(time.time()):
    ...
    response = requests.get(
        "https://backend.production.omeda-aws.com/api/public/get-matches-since/%d/"
        % (current_epoch)
    )
    ...
    for data in json_response:
        ...
        for player in data["playerData"]:
            ...
            if player["playerName"] == "Yolk_Toast":
                print("joe")
